# User Manual — PyCC2 **v0.3.42**

> **This document has been updated to v0.3.42. For earlier version information, see Git history.**

*Manual version: 2.0 — For PyCC2 v0.3.42 | Last updated: 2026-06-14*
...
| Version | Date | Notes |
|---------|------|-------|
| v2.0 | 2026-06-14 | **v0.3.42**: Updated to current version — launch via `pycc2`, 7-command hotkey system (Z/X/S/C/V/D/H), save format save_slot_X.json, 63 maps, 277 unit templates, ~3513 tests, CC2 fidelity ~88% |
...
---
*Manual version: 2.0 — For PyCC2 v0.3.42*
