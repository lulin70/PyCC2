...
| **v0.7.3** | **Interface Fix** | **M3** | **~75%** | **~6156** | **day_night_cycle 接口兼容性修复: time_of_day 重命名为 time_phase (enum) + 新增 time_of_day 返回 float (0.0-24.0) + game_loop_updating 调用方适配** | ✅ **Current** |
...
**Created**: 2026-05-19
**Updated**: 2026-07-17
**Status**: Beta Candidate — P0-P3 全部完成; v0.6.10 覆盖率提升+CI增强; v0.6.11 ghost 模块清理; v0.7.0 TD-076b/c/d 接入; v0.7.1 TD-077 三步走 (DELETE 4 + ARCHIVE 10 + ORPHAN 8); v0.7.2 INTEGRATE 前置准备 (文档同步 + flaky benchmark 修复 + ORPHAN smoke tests); v0.7.3 day_night_cycle 接口兼容性修复 (time_of_day 重命名为 time_phase + 新增 time_of_day 返回 float 0.0-24.0 + game_loop_updating 调用方适配)
...
**Related Documents**: [GAP_ANALYSIS.md](docs/GAP_ANALYSIS.md) | [TECH_DEBT.md](docs/TECH_DEBT.md) | [VISUAL_FIDELITY_IMPROVEMENT_PLAN.md](VISUAL_FIDELITY_IMPROVEMENT_PLAN.md) | [ROADMAP_v0.7.2.md](docs/ROADMAP_v0.7.2.md) | [ROADMAP_v0.7.3.md](docs/ROADMAP_v0.7.3.md)
