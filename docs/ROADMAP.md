...
> **Current Version**: v0.5.3 | **Tests**: ~5338 (all passing) | **CC2 Fidelity**: ~72% (Visual ~67% / Mechanics ~78%) ⚠️ v0.5.0 P0 PixVoxel 接入 + v0.5.1 P2 isometric 清理 + v0.5.2 P1 调色板修正 + v0.5.3 P1 纹理调优
