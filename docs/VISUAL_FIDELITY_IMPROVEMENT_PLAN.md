...
> **版本**: v0.6.0 | **日期**: 2026-07-11 | **状态**: P0 ✅ + P2 ✅ + P1 ✅ + P3-1 ✅ 已完成
...
| P3-2 | 建筑窗户射击弧验证 | 验证建筑驻守的窗户射击弧限制 | [los_system.py](../src/pycc2/domain/systems/los_system.py) `check_window_firing_arc` | 1 天 | 待定 |
| P3-3 | 散兵坑/战壕 | 实现专用掩体类型 | [terrain_type.py](../src/pycc2/domain/value_objects/terrain_type.py) | 1-2 天 | 待定 |
| P3-4 | AI 侦察行为 | 实现侦察单位派出和行为 | 新建 `recon_ai.py` | 2-3 天 | 待定 |
| P3-5 | AI 心理模型 | 实现士兵可能拒绝命令 | 新建 `psychology_system.py` | 2-3 天 | 待定 |
| P3-6 | AI 补给线意识 | 实现保护/切断补给线行为 | 新建 `supply_awareness_ai.py` | 2-3 天 | 待定 |
...
**P0 + P2 + P1 + P3-1 已完成 (v0.6.0)，下一步推进 P3-2：建筑窗户射击弧验证**

---

**文档状态**: P0 ✅ + P2 ✅ + P1 ✅ + P3-1 ✅ 已完成 (v0.6.0, 2026-07-11)，待推进 P3-2~P3-6
