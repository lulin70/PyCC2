...
| 指标 | 数值 | 来源 |
|------|------|------|
| 版本号 | 0.7.2 | `pyproject.toml` / `src/pycc2/__init__.py` / `VERSION` |
...
| 测试用例数 | 6174 collected / 6156 passed / 2 skipped (v0.7.2 INTEGRATE 前置准备后，not slow 基线) | `pytest tests/ -m "not slow" --co -q` |
