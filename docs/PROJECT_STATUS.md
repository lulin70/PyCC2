...
- 3 个 >1000 行文件待拆分（deployment_renderer / campaign_ui_rendering / pixvoxel_loader）— terrain_tile_generator + infantry_pixel_renderer 已于 2026-07-04 Phase 2 完成
...
- [~] 5 个 >1000L 文件拆分（P0-1 进行中: 2/5 完成 — terrain_tile_generator + infantry_pixel_renderer 已拆分，剩余 campaign_ui_rendering / deployment_renderer / pixvoxel_loader）
