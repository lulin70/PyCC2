...
| 指标 | 数值 | 来源 |
|------|------|------|
| 版本号 | 0.7.1 | `pyproject.toml` / `src/pycc2/__init__.py` / `VERSION` |
...
| 测试用例数 | 6157 collected / 6138 passed / 2 skipped (v0.7.1 ghost 模块分类清理后，not slow 基线) | `pytest tests/ -m "not slow" --co -q` |
