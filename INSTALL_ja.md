# インストールガイド — PyCC2 **v0.3.42**

> **このドキュメントはv0.3.42に更新されています。以前のバージョン情報はGit履歴を参照してください。**

PyCC2 v0.3.42の全サポートプラットフォームにおける完全なインストール手順。

### バージョン履歴

| バージョン | 日付 | メモ |
|------------|------|------|
| v2.0 | 2026-06-14 | v0.3.42に更新: テスト~3513, 起動方法 `pycc2`, コア依存関係(pygame/numpy/pydantic) |
