...
class GameLoop:
    ...
    def __post_init__(self) -> None:
        ...
        self._pause_menu = PauseMenuController()
        ...
        self._event_dispatcher = ED(
            ...
            tutorial_overlay=self.tutorial_overlay,
            hud_manager=self._hud_manager,
            sound_system=self.sound_system,
            event_bus=self.event_bus,
            display_config=self.display_config,
            victory_manager=self._victory_manager,
            quick_save_fn=self.quick_save,
            quick_load_fn=self.quick_load,
