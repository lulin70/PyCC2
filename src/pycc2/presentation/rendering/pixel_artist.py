...
class CCPalette(Enum):
    ...
    2026-05-29更新: 应用额外7%全局去饱和（Phase 1 Fix 0.4）
    ...
    DIRT_ROAD = (93, 79, 55)         # 原始(95,80,55)
    DIRT = (129, 100, 58)            # 原始(131,102,58)

    # Water — dark blue-grey, semi-transparent
    WATER_DEEP = (25, 54, 94)        # 原始(25,55,95)
    WATER_SHALLOW = (47, 94, 158)    # 原始(48,96,160)
    WATER_FOAM = (123, 160, 198)     # 原始(125,163,201)

    TREE_CROWN = (37, 73, 33)         # 原始(38,74,33)
    TREE_CROWN_DARK = (27, 58, 25)   # 原始(28,59,25)
    TREE_TRUNK = (80, 57, 34)        # 原始(81,58,34)
    HEDGE_GREEN = (44, 83, 34)       # 原始(45,85,34)

    # Building roofs — match CC2 exactly
    BUILDING_WALL = (175, 166, 148)   # 原始(178,169,150)
    BUILDING_ROOF = (137, 95, 63)     # 原始(139,96,64)
    BUILDING_SHADOW = (99, 61, 42)    # 原始(101,62,42)
    ROAD_MARK = (119, 96, 53)        # 原始(121,97,53)
    CONCRETE = (156, 151, 141)       # 原始(159,154,144)
    SAND = (176, 161, 119)           # 原始(179,164,121)
    MUD = (136, 104, 24)             # 原始(138,106,24)
    SNOW = (226, 230, 235)           # 原始(229,234,239)
    WIRE = (100, 100, 100)           # 原始(102,102,102)
    BUNKER = (118, 113, 104)         # 原始(120,115,106)
    ALLIES_HELMET = (85, 104, 50)    # 原始(86,106,50)
    ALLIES_UNIFORM = (76, 82, 34)     # 原始(77,83,34)
    AXIS_HELMET = (56, 58, 51)       # 原始(57,59,52)
    AXIS_UNIFORM = (85, 92, 80)      # 原始(86,93,81)
    WATER = (34, 69, 118)            # 原始(35,70,120)
    WOOD_TRUNK = (80, 57, 34)        # 原始(81,58,34)
    WOOD_LEAF_DARK = (37, 73, 33)    # 原始(38,74,33)
    WOOD_LEAF_LIGHT = (75, 122, 35)  # 原始(76,124,35)
    BUILDING_WINDOW = (83, 118, 157)  # 原始(84,120,159)
    BUILDING_DOOR = (99, 65, 36)      # 原始(101,66,36)
