    ...
    def _draw_sprite_unit(
        ...
        if is_prone:
            ...
            sprite = (
                ...
                or self._sprite_cache.get(f"{base_key}_{self.SPRITE_SIZE}")
                or self._sprite_cache.get(f"{faction}_{utype}_d0")
                or self._sprite_cache.get(f"{faction}_{utype}_d0_{self.SPRITE_SIZE}")
                or None
            )
