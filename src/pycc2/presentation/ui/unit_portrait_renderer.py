...
class UnitPortraitRenderer:
    ...
    def _render_background_layer(
        ...
        if faction == Faction.ALLIES:
            base_color = (45, 85, 55)  # Olive green
        else:
            base_color = (75, 70, 60)  # Gray-brown
    ...
    def _render_shoulder_layer(
        ...
        if faction == Faction.ALLIES:
            uniform_color = (60, 100, 70)
        else:
            uniform_color = (90, 85, 75)
    ...
    def _render_helmet_layer(
        ...
        """Layer 4: Helmet/headgear (unit type specific)"""
        if faction == Faction.ALLIES:
            helmet_color = (50, 80, 50)  # Dark olive
        else:
            helmet_color = (70, 70, 70)  # Dark gray
