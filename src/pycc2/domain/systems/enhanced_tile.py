...
class EnhancedTile:
    ...
    def total_cover_bonus(self) -> int:
        ...
        terrain_cover = {
            0: 0,
            1: 0,
            2: 0,  # Open ground: no cover
            3: 1,  # Forest: light cover
            4: 2,  # Rock: medium cover
            5: 3,
            8: 2,  # Building/urban: heavy/medium cover
            6: 0,
            10: 0,  # Water: no cover
            7: 2,  # Trench/dirt: medium cover
            9: 1,
            11: 0,  # Rough/open: light/no cover
        }
    ...
    def effective_movement_cost(self) -> float:
        ...
        terrain_cost = {
            0: 1.0,
            1: 0.7,
            2: 1.0,  # Normal/road/grass
            3: 2.0,  # Forest: slow
            4: 1.5,  # Rock: slower
            5: 1.5,
            8: 1.5,  # Building: slower inside
            6: 999.0,
            10: 2.0,  # Water: impassable/slow
            7: 1.0,  # Trench: normal
            9: 1.3,
            11: 1.2,  # Rough: slightly slow
        }
...
class TileConverter:
    ...
    def convert_map_data(map_data: dict[str, Any]) -> dict[str, Any]:
        ...
        # Build new map data
        new_data = {**map_data}
        new_data["tiles_enhanced"] = [[tile.to_dict() for tile in row] for row in enhanced_tiles]
