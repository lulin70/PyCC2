...
class IInteractionController(Protocol):
    ...
    def handle_right_mouse_up(self, screen_pos: tuple[float, float], units: list[Any]) -> None: ...

    def handle_mouse_move(self, screen_pos: tuple[float, float], units: list[Any]) -> None: ...
